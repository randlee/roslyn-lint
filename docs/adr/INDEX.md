...
This index lists repository-wide ADRs in `docs/adr/`.

## Repository ADRs

- [ADR-001 — Analyzer-First Phase A And Replacement-First Spike Policy](./ADR-001-analyzer-first-replacement-policy.md)
- [ADR-002 — Roslyn.DeMagic AdditionalFiles Configuration Boundary](./ADR-002-demagic-additionalfiles-config.md)
