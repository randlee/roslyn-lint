...
manifest_path="$repo_root/eng/sc-lint-roslyn-demagic-package-expected-diagnostics.json"
sample_project="$repo_root/examples/sc.lint.roslyn.demagic.package-smoke/sc.lint.roslyn.demagic.package-smoke.csproj"
...
dotnet pack "$repo_root/src/sc.lint.roslyn.demagic/sc.lint.roslyn.demagic.csproj" \
...
print("sc-lint-roslyn-demagic package validation passed.")
