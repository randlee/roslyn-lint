...
$ManifestPath = Join-Path $RepoRoot 'eng/sc-lint-roslyn-demagic-package-expected-diagnostics.json'
$SampleProject = Join-Path $RepoRoot 'examples/sc.lint.roslyn.demagic.package-smoke/sc.lint.roslyn.demagic.package-smoke.csproj'
...
dotnet pack (Join-Path $RepoRoot 'src/sc.lint.roslyn.demagic/sc.lint.roslyn.demagic.csproj') `
...
Write-Host 'sc-lint-roslyn-demagic package validation passed.'
